        ...
        >
          ...
          <motion.section variants={fadeUp} className={styles.hero}>
            <div className={styles.heroContent}>
              ...
              <p className={styles.description}>
                Protege tu empresa con abogados especializados en derecho
                comercial en Bogotá y Colombia. Asesoría en contratos,
                sociedades, negociaciones y conflictos empresariales.
              </p>
          ...
          <motion.section variants={fadeUp}>
            ...
            <p className={styles.text}>
              El derecho comercial en Colombia es la rama del derecho encargada
              de regular todas las actividades económicas, los actos de comercio
              y las relaciones entre empresas, comerciantes y organizaciones.
            </p>

            <div className={styles.highlightBox}>
              <strong>Importante:</strong> En Bogotá, el derecho comercial es
              clave para la estabilidad empresarial.
            </div>

            <p className={styles.text}>
              Este campo del derecho abarca la constitución de sociedades,
              contratos comerciales y resolución de conflictos empresariales.
            </p>
          </motion.section>
          ...
          <motion.section variants={fadeUp}>
            ...
            <p className={styles.text}>
              Los contratos son la base de toda relación empresarial en
              Colombia.
            </p>
          </motion.section>
