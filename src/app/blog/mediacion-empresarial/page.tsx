...
const schema = {
  ...
  "@type": "BlogPosting",
  headline: "Mediación empresarial: solución rápida para conflictos",
  description:
    "Descubre qué es la mediación empresarial, cómo funciona y cuáles son sus beneficios para resolver conflictos comerciales de forma rápida, económica y colaborativa.",
  author: {
    "@type": "Organization",
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://pravice.co/blog/mediacion-empresarial",
  },
};
