import styles from "./ArticuloIA.module.css";
...
export default function ArticuloIA() {
  return (
    <article className={styles.articulo}>
      ...
      <h2>¿Qué es la inteligencia artificial aplicada a cobranzas?</h2>
      ...
      <h2>Problemas de las cobranzas tradicionales</h2>
      ...
      <h2>Aplicaciones de la inteligencia artificial en cobranzas</h2>

      <h3>1. Predicción de comportamiento de pago</h3>
      <p>
      ...
      <h3>4. Optimización de estrategias de cobranza</h3>
      <p>
      ...
      <h3>5. Chatbots para atención de clientes</h3>
      <p>
      ...
      <h2>Beneficios de utilizar inteligencia artificial en cobranzas</h2>
      ...
      <h3>Mejora en la recuperación de cartera</h3>
      <p>
      ...
      <h2>Futuro de la inteligencia artificial en cobranzas</h2>
